...
public class BlockLiquidExperience extends BlockFluidInteractive {
    ...
    private void applyInteractionsNear(final World world, final BlockPos pos) {
        for (int i = 0; i < 3; i++) {
    ...
    private void interactWithBlock(final World world, final BlockPos pos) {
    ...
    private void triggerInteractionEffects(final World world, final int x, final int y, final int z) {
